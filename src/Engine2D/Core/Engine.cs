...
//        private FramebufferSpec _spec;
        ...
        {
            // _spec = new FramebufferSpec(new []
            // {
            //     new FramebufferTextureSpec(FramebufferTextureSpec.FramebufferTextureFormat.DEPTH),
            //     new FramebufferTextureSpec(FramebufferTextureSpec.FramebufferTextureFormat.RED_INTEGER),
            // });
            //
            // base.OnLoad();
            //
