...
{    
    ...
    //     
    //     _stopBtn = (IntPtr)ResourceManager.GetTexture(
    //         TextureData.CopyToNew(data,
    //             Utils.GetBaseEngineDir() + "\\images\\Icons\\Stop.png")
    //         ).TexID;
    // }
    //
    ...
    //
    //             Engine.Get().CurrentScene.Renderer.EditorGameBuffer = new TestFrameBuffer(
    //                   (int)_windowSize.X, 
    //                  (int)_windowSize.Y);
    //         };
    //            
    ...
    //         
    //         if (ImGui.BeginChild("left_bar", new System.Numerics.Vector2(s * 3 + 40, s + 30), true, ImGuiWindowFlags.NoScrollbar))
    //         {
    //             IntPtr world = _playBtn;
    //             IntPtr local = _stopBtn;
    //             
    //             IntPtr btn = _currentMode == MODE.WORLD ? world : local;
    //
    //             if (ImGui.ImageButton(btn, new System.Numerics.Vector2(s - 2, s)))
    //             {
    //                 _currentMode = _currentMode == MODE.WORLD ? MODE.LOCAL : MODE.WORLD;
    //             }
    //             ImGui.SameLine();
    //             
    ...
    //
    //         if(ImGui.BeginChild("middle_bar",new System.Numerics.Vector2(s*3 + 40, s+30), true, ImGuiWindowFlags.NoScrollbar))
    //         {
    ...
    public override void OnGui(TestCamera? cameraToRender, string title)
    {
        ImGui.Begin(title);
        {
            ...
            {
                Logging.Log.Succes("Creating new Frame Buffer");
                Engine.Get().CurrentScene.Renderer.EditorGameBuffer = new TestFrameBuffer(vp);
                cameraToRender ?.SetViewportSize (vp);
            }
