...
public class TestRenderer : Renderer<DefaultRenderBatch>
{
    ...
    {
        FramebufferSpec fbts = new FramebufferSpec(new []
        {
            new FramebufferTextureSpec(FramebufferTextureSpec.FramebufferTextureFormat.RGBA8)
        });
        
        return new Framebuffer(1920, 1080,
            fbts);
    }
    ...
    protected override void UploadUniforms(Shader shader)
    {
        ...
        Vector2[] lightPositions = new Vector2[numberOfLights];
        Vector3[] lightColors = new Vector3[numberOfLights];
